...
const city = "Bila Tserkva";
const msg = `Я живу в місті ${city}`;
...
const priceString2 = `Ціна: ₴${price}`;
console.log(priceString2); // Виведе: "Ціна: ₴500"
// ---Windows: Shift + ~ (натиснути Shift та клавішу з тильдою/буквою Ё, що знаходиться зліва від цифри 1).
